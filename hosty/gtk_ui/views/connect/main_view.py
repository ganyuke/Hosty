...
class ConnectView(Gtk.Box, LocalIpMixin, PlayersMixin, PlayitMixin):
    ...
    def _build_ready_page(self) -> Gtk.Widget:
        ...
        self._delete_java_tunnel_btn = Gtk.Button(icon_name="user-trash-symbolic", valign=Gtk.Align.CENTER)
        ...
        self._tunnel_domain_row.add_suffix(self._delete_java_tunnel_btn)
        ...
        self._delete_bedrock_tunnel_btn = Gtk.Button(icon_name="user-trash-symbolic", valign=Gtk.Align.CENTER)
        ...
        self._bedrock_domain_row.add_suffix(self._delete_bedrock_tunnel_btn)
